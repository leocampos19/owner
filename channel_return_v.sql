...
create or replace view de_case_leocampos19_schema.channel_return_v as
with base as (
select
    sales_channel,
    stage_name,
...
from base b
--where sales_channel = 'Outbound'
group by all
order by all;

select * from de_case_leocampos19_schema.channel_return_v;
